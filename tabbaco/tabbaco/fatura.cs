...
namespace tabbaco
{
    public partial class fatura : Form
    {
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut1 = new NpgsqlCommand("insert into public.fatura (fatura_id,toplam_tutar) values ('" + textBox1.Text + "','" + textBox2.Text + "')", baglanti);
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut2 = new NpgsqlCommand("Delete from public.fatura where fatura_id=@p1", baglanti);
        ...
        {
            baglanti.Open();
            NpgsqlCommand guncelle = new NpgsqlCommand("update public.fatura set toplam_tutar=@p1 where fatura_id=@p2", baglanti);
